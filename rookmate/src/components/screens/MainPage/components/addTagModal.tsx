  ...
  return(
    <div className={ModuleCss.modalBackground}>
      <div className={ModuleCss.tagModalBox}>
        <img src={images.addTag} className={ModuleCss.tagModalExitButton} onClick={handleTagModalVisible}/>
        <div className={ModuleCss.tagModalTitle}>관심분야 추가하기</div>
        <div className={ModuleCss.tagManager}>
          <div className={ModuleCss.addedTagBox}>
            <p className={ModuleCss.tagModalSubTitle}>추가된 관심분야(최대 9개)</p>
        ...
        <button onClick={handleTagModalVisible} className={ModuleCss.saveButton}>저장</button>
      </div>
    </div>
  )
}
