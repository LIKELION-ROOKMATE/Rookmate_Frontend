...
const WorkDetailModal: React.FC<WorkDetailModalType> = ({
  visible,
  setWorkModalVisible,
  modalImageList,
}) => {
        ...
        <div className={ModuleCss.comment}>
          ...
          <div className={ModuleCss.toolBox}>
            <button className={ModuleCss.tool}>
              <img src={images.mail} className={ModuleCss.toolImg} alt="메일" />
            </button>
            <button className={ModuleCss.tool}>
              <img
                src={images.thumbsUp}
                className={ModuleCss.toolImg}
                alt="좋아요"
              />
              <p>30</p>
            </button>
  ...
  return (
    ...
    >
      <div className={ModuleCss.workModalContainer}>
        <button
          className={ModuleCss.exitButton}
          id="exitButton"
          onClick={exitModalEvent}
        >
          <img
            src={images.addTag}
        ...
        <button
          className={ModuleCss.outsourcingButton}
          id="outsourcingButton"
          onClick={handleNavigateOutsourcing}
        >
          <img
            src={images.outsourcingApply}
        ...
        <div className={ModuleCss.imageAndExplain}>
          <div className={ModuleCss.imageBox}>
            <img
              src={modalImageList[0]}
              className={ModuleCss.mainImage}
              alt=""
            />
            <div className={ModuleCss.subImageBox}>
              <img
                src={modalImageList[0]}
                className={ModuleCss.subImage}
                alt=""
              />
              <img
                src={modalImageList[0]}
          ...
          <div className={ModuleCss.explainBox}>
            <div className={ModuleCss.userInfoAndTool}>
              ...
              <div className={ModuleCss.toolContainer}>
                ...
                <button className={ModuleCss.tool}>
                  <img src={images.mail} className={ModuleCss.toolImg} alt="" />
                </button>
                <button className={ModuleCss.tool}>
                  <img
                    src={images.bookMark}
            ...
            <div className={ModuleCss.explainContent}>
              combine&divide 실험으로 제작한 매스모형입니다. 우드락과 아크릴을
              사용해서 만들었고요.표면은 mapping을 통해 질감표현을 해보았습니다.
              그래스호퍼를 통해 모델링을 먼저 진행한 후 적당한 이미지를 찾아서
              모형으로 디벨롭한 것입니다.
            </div>
        ...
        <div className={ModuleCss.commentAndMore}>
          ...
          <div className={ModuleCss.moreWorksContainer}>
            ...
            <div className={ModuleCss.moreWorksImageBox}>
              <img
                src={images.mainPageExampleImage}
                className={ModuleCss.moreWorksImage}
                alt=""
              />
              <img
                src={images.mainPageExampleImage}
