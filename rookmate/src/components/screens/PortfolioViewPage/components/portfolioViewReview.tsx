...
const styles:Styles = {
  ...
  work:{
    width:"7.43rem", height:"7.43rem",
  },
}

const PortfolioEditReview:React.FC<portfolioViewReviewType> = ({userReview})=>{
      ...
      tmpReviewList.push(
        <div>
          <div style={styles.reviewBox}>
            <img src={userData.profile} style={{width:"3.1rem", height:"3.1rem",}} alt='profile'/>
            <div style={styles.reviewDetail}>
              <div style={styles.basicUserInfo}>
                <div style={styles.IdAndScore}>
                  <p style={{color: "#000",fontSize: "1rem",}}>{userName}({userData.id})</p>
                  <p style={{color: "#000",fontSize: "0.75rem",fontWeight:"700",}}>{userData.score}</p>
                </div>
                <div style={styles.reviewTools}>
                  <img src={images.mail} style={{width:"1.8rem", height:"1.5rem",}} alt='mail'/>
                  <div style={styles.thumbsUpBox}>
                    <img src={images.thumbsUp} style={{width:"1.5rem", height:"1.5rem",}} alt='thumbsup'/>
                    <p style={{display:"flex", justifyContent:"center", color:"#888",fontSize: "0.75rem",}}>{userData.prefer}</p>
                  </div>
                </div>
              </div>
              <div style={{color:"#000", fontSize:"0.75rem",}}>{userData.comment}</div>
