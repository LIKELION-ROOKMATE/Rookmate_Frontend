...
const PortfolioViewUserComment: React.FC<PortfolioViewUserCommentType> = ({
  userComment,
}) => {
            ...
            <div style={styles.userComment}>
              <div style={styles.CommentHead}>
                <div style={styles.rowDirection}>
                  ...
                  <p style={{ color: "#000", fontSize: "0.75rem" }}>
                    {data[1].date}
                  </p>
                </div>
                <div style={styles.rowDirection}>
                  ...
                  <img
                    src={images.mail}
                    style={styles.mailToolImg}
                    alt="mail"
                  />
                  <div style={styles.preferTool}>
                    <img
                      src={images.thumbsUp}
                      style={styles.preferToolImg}
                      alt="thumbsup"
                    />
                    <p
                      style={{
