      ...
      initialStack.push(
        <div className="stackBox">
          ...
          <div className="proficiencyBox">
            <div style={{ width: `${dataList[i]}%` }} className="proficiency">
              &nbsp;
            </div>
          </div>
        </div>
  ...
  return (
    <div className="page">
      ...
      <div className="img-timeline-box">
        ...
        <div
          className="timeline"
          style={viewList.timeline ? {} : style.DisplayNone}
        >
      ...
      <div className="portfolioDetail">
        <div className="profile">
          ...
          <div
            className="stack"
            style={viewList.stack ? {} : style.DisplayNone}
          >
          ...
          <div className="templateEditTools">
            <div className="toolBoxGroup">
              ...
              <div className="toolBox">
                <button
                  onClick={checkViewListEvent}
                  id="stack"
                  style={viewList.stack ? {} : { color: "grey" }}
                >
                  스택
                </button>
                <button
                  onClick={checkViewListEvent}
                  id="timeline"
                  style={viewList.timeline ? {} : { color: "grey" }}
                >
                  타임라인
                </button>
                <button
                  onClick={checkViewListEvent}
                  id="license"
                  style={viewList.license ? {} : { color: "grey" }}
                >
                  자격증
                </button>
                <button
                ...
                <button
                  onClick={checkViewListEvent}
                  id="competition"
                  style={viewList.competition ? {} : { color: "grey" }}
                >
                  공모전
                </button>
              </div>
